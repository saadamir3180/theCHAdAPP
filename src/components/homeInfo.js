  ...
  return (
    <div className="home">
        <div className="homeInfo">
          <h1>
            Helping you connect with <br /> like-Minded people.
          </h1>
          <p>
            With <b>the CHAd APP</b>, find, build and Manage your Niche
            Community
            <br /> as a Member, Influencer, or the Leader.
          </p>
          <SignIn />
        </div>
          <div className="homeSvg">
            <svg
              ...
              width="565.82539"
              height="329.2137"
              viewBox="0 0 965.82539 629.2137"
            >
              <path
